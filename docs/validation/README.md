...
and [CMIP6 model-license join](mcp-stage-1/cmip6-license-scope.md) are inputs to
the still-unapproved shared availability-service implementation plan. They do not
