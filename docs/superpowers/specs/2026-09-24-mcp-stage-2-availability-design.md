...
Stage 2 ends with a reviewable shared service and evidence-preserving local catalog. Stage 3 owns richer batch mapping/compact export; Stage 4 owns the final local MCP protocol; Stage 5 designs an agent harness and evaluations; Stage 6 pilots the local client experience. Team deployment is outside the current staged roadmap.
