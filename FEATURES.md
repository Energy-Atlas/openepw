...
| Interactive console chat | Implemented, offline tested | Local stdio conversation with automatic plan execution, EPW upload/inspect/save and in-session artifact references; existing ignored `.env` read only |
